...
from .models import Candidate, JobDescription, ScoringCard, MatchRequest
...
def create_matching_task(request: MatchRequest):
    """
    Submit a task to run the AI Matching and Scoring asynchronously
    based on Job requirements vs Candidate signals.
